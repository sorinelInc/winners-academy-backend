...
import org.vaadin.paul.spring.model.Company;
...
public class MatchesView extends VerticalLayout {
    ...
    private Grid<Company> createGrid() {
        ...
        grid.addColumn(Company::getCompanyName).setHeader("Company name")
                .setWidth("160px").setHeader("ASDADA");
        grid.addColumn(Company::getContactName).setHeader("Contact person");
        grid.addColumn(Company::getPhone).setHeader("Phone");
